...
The book has 11 chapters, but only 10 of them are printed in the book, the 11th chapter is [offered on line](http://www.packtpub.com/sites/default/files/downloads/Escaping_Singleness.pdf) and free of charge. This chapter explains how to let Cinder talk with other softwares, with the help of Syphon and OSC protocol. This chapter is really nice, I don't why it's excluded from the printed book.
...
本书很厚道地提供了[一章免费的试读](http://www.packtpub.com/sites/default/files/downloads/Escaping_Singleness.pdf)，讲解了如何与其他开发环境通信，使用的通信工具有 Syphon 和 OSC 协议。这章非常精彩，不知为何并没有放入实体书中。